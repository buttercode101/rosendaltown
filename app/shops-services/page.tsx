...
export default function ShopsPage() {
  const meta = directoryMeta.shops;
  const items = directory.shops;
  return (
    <>
                  ...
                  <div className="relative aspect-[4/3] overflow-hidden">
                    {b.image ? (
                      <MaskReveal className="absolute inset-0">
                        <Image src={b.image} alt={b.name} fill loading="lazy" className="object-cover transition-transform duration-700 group-hover:scale-105" />
                        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-forest-deep/40 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                      </MaskReveal>
                    ) : (
