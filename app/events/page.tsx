        ...
        <div className="container-editorial">
          <Stagger className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {events.map((e) => {
              ...
              return (
                <StaggerItem key={e.title} className="group overflow-hidden rounded-2xl border border-ink/10 bg-white" data-cursor="grow">
                  <div className="flex gap-5 p-6">
                    ...
                    <div>
                      ...
                      <div className="mt-2 text-xs text-muted-foreground">{e.date}</div>
          ...
          <p className="mt-10 text-center text-sm text-muted-foreground">Dates for 2026 as listed on the official Rosendal events calendar. Confirm with venues before travelling.</p>
        </div>
      </section>
    </>
  );
